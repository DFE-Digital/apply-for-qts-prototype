      ...
      var a = (function (n) {
        ...
        return (
          ...
          (t.handleInputBlur = function (e) {
            ...
            if (!(-1 !== n)) {
              var a = r && Z(),
                s = Z() ? i : this.templateInputValue(o[u]);
          ...
          (t.render = function () {
            var e,
              ...
              k = 0 !== C.length,
              P = C.length >= o,
              j = this.props.showNoOptionsFound && A && I && k && P,
              L = n + "__wrapper",
              T = n + "__input",
              B = null !== b ? " " + T + "--focused" : "",
              ...
              Q =
                K && 0 === K.toLowerCase().indexOf(C.toLowerCase()) && N
                  ? C + K.substr(C.length)
                  : "",
              z = u + "__assistiveHint",
              G = E ? { "aria-describedby": z } : null;
            return (
              c &&
                "string" == typeof (e = y({ className: F })) &&
              ...
              (0, J.createElement)(
                "div",
                { className: L, onKeyDown: this.handleKeyDown },
                  ...
                  Y(
                    {
                      ...
                      "aria-activedescendant": !!R && u + "__option--" + b,
